...
LOCAL_PATH := device/samsung/klimtxx
...
# Bootloader
TARGET_OTA_ASSERT_DEVICE := klimtxx

# Kernel
TARGET_KERNEL_CONFIG := lineageos_deathly_klimtxx_defconfig
...
BOARD_SEPOLICY_DIRS += device/samsung/klimtxx/sepolicy
